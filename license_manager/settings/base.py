...
# Mailchimp
MAILCHIMP_ASSIGNMENT_EMAIL_TEMPLATE = ''
MAILCHIMP_ASSIGNMENT_EMAIL_SUBJECT = ''
MAILCHIMP_REMINDER_EMAIL_TEMPLATE = ''
MAILCHIMP_REMINDER_EMAIL_SUBJECT = ''
MAILCHIMP_ACTIVATION_EMAIL_SUBJECT = ''
MAILCHIMP_ACTIVATION_EMAIL_TEMPLATE = ''
MAILCHIMP_AUTOAPPLY_NO_LEARNER_PORTAL_TEMPLATE = ''
MAILCHIMP_AUTOAPPLY_NO_LEARNER_PORTAL_SUBJECT = ''
MAILCHIMP_AUTOAPPLY_WITH_LEARNER_PORTAL_TEMPLATE = ''
MAILCHIMP_AUTOAPPLY_WITH_LEARNER_PORTAL_SUBJECT = ''
MAILCHIMP_REVOKE_CAP_EMAIL_TEMPLATE = ''
MAILCHIMP_REVOKE_CAP_EMAIL_SUBJECT = ''
MAILCHIMP_BULK_ENROLL_RESULT_TEMPLATE = ''
MAILCHIMP_BULK_ENROLL_RESULT_SUBJECT = ''
MAILCHIMP_INITIAL_LICENSE_UTILIZATION_TEMPLATE = ''
MAILCHIMP_INITIAL_LICENSE_UTILIZATION_SUBJECT = ''
MAILCHIMP_NO_ALLOCATIONS_REMAINING_TEMPLATE = ''
MAILCHIMP_NO_ALLOCATIONS_REMAINING_SUBJECT = ''
MAILCHIMP_LIMITED_ALLOCATIONS_REMAINING_TEMPLATE = ''
MAILCHIMP_LIMITED_ALLOCATIONS_REMAINING_SUBJECT = ''
MAILCHIMP_PRESERVE_RECIPIENTS = False
MAILCHIMP_MERGE_LANGUAGE = 'mailchimp'

MAILCHIMP_API_KEY = os.getenv('MAILCHIMP_API_KEY', '')
MAILCHIMP_FROM_EMAIL = os.getenv('MAILCHIMP_FROM_EMAIL', None)
MAILCHIMP_FROM_NAME = os.getenv('MAILCHIMP_FROM_NAME', None)
