...
# Braze
AUTOAPPLY_WITH_LEARNER_PORTAL_CAMPAIGN = os.environ.get('AUTOAPPLY_WITH_LEARNER_PORTAL_CAMPAIGN', '')
AUTOAPPLY_NO_LEARNER_PORTAL_CAMPAIGN = os.environ.get('AUTOAPPLY_NO_LEARNER_PORTAL_CAMPAIGN', '')
WEEKLY_LICENSE_UTILIZATION_CAMPAIGN = os.environ.get('WEEKLY_LICENSE_UTILIZATION_CAMPAIGN', '')
NO_ALLOCATIONS_REMAINING_CAMPAIGN = os.environ.get('NO_ALLOCATIONS_REMAINING_CAMPAIGN', '')
LIMITED_ALLOCATIONS_REMAINING_CAMPAIGN = os.environ.get('LIMITED_ALLOCATIONS_REMAINING_CAMPAIGN', '')
BRAZE_ASSIGNMENT_EMAIL_CAMPAIGN = os.environ.get('BRAZE_ASSIGNMENT_EMAIL_CAMPAIGN', '')
BRAZE_ACTIVATION_EMAIL_CAMPAIGN = os.environ.get('BRAZE_ACTIVATION_EMAIL_CAMPAIGN', '')
BRAZE_REMIND_EMAIL_CAMPAIGN = os.environ.get('BRAZE_REMIND_EMAIL_CAMPAIGN', '')
BRAZE_REVOKE_CAP_EMAIL_CAMPAIGN = os.environ.get('BRAZE_REVOKE_CAP_EMAIL_CAMPAIGN', '')
