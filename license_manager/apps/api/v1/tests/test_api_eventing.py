...
class EventTestCaseBase(TestCase):
    ...
    def setUp(self):
        ...
        self.mock_track_license_changes_mocker = mock.patch(
            'license_manager.apps.api.api.tasks.track_license_changes_task.delay',
...
class LicenseLearnerActionsEventTests(LicenseViewTestMixin, TestCase):
    @mock.patch('license_manager.apps.api.api.tasks.send_post_activation_email_task.delay')
