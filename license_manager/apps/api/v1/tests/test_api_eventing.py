...
class LicenseViewSetActionEventTests(LicenseViewSetActionMixin, TestCase):
    ...
    def test_assign_previously_revoked_eventing(self):
        """
    ...
    def test_assign_dedupe_eventing(self):
        """
    ...
    @ddt.data(True, False)
    def test_assign_eventing(self, use_superuser):
    ...
    def test_bulk_revoked_event(self):
        """
    ...
    def test_license_revoked_event(self):
