...
SUBSCRIPTION_PLAN_RENEWAL_PROVISIONING_ADMIN_CRUD_API_TAG = "Subscription Plan Renewal CRUD"
...
class SubscriptionPlanRenewalProvisioningAdminViewset(
    ...
    def destroy(self, request, *args, uuid=None, **kwargs):
        ...
        Note (Troy): Tickets in the epic suggest this should be a soft-delete, but the current
        implementation does a hard-delete.
        """
