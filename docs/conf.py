...
htmlhelp_basename = 'license_managerdoc'
...
latex_documents = [
    ('index', 'license_manager.tex', 'License Manager Documentation',
     'edX', 'manual'),
]
...
man_pages = [
    ('index', 'License Manager', 'License Manager Documentation',
     ['edX'], 1)
]
...
texinfo_documents = [
    ('index', 'License Manager', 'License Manager Documentation',
     'edX', 'License Manager', 'License Manager',
     'Miscellaneous'
     ),
]
